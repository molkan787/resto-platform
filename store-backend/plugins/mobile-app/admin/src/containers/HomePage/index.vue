<template>
    <div class="mobile-app-page-index">
        <section class="card">
            <h2>Mobile App</h2>
            <p>
                Generate mobile app for your restaurant. <br>
                To get started select store and click generate.
            </p>
            ...
            <input v-model.trim="primaryColor" name="primaryColor"
                placeholder="Format: R,G,B (ex: 247, 184, 10)" /> <br>
